...
func main() {
	outPath := flag.String("out", "index_time_yandex.json", "output json path")
	...
	fmt.Printf("[CLIENT] vec_dim=%d measure=%d start_row=%d batch_size=%d threshold=%d distance=dot hnsw.efConstruction=100 hnsw.maxConnections=16\n",
