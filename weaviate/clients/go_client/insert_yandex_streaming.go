...
func parseFlags() (config, error) {
	...
	flag.StringVar(&cfg.className, "class-name", getenvDefault("CLASS_NAME", "YANDEX"), "Weaviate class name")
	...
	flag.StringVar(&cfg.distanceMetric, "distance-metric", getenvDefault("DISTANCE_METRIC", "dot"), "Distance metric")
