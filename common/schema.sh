...
register_common_var "PLATFORM" "required" "" "POLARIS AURORA" "Target platform"
register_common_var "ACCOUNT" "required" "" "" "PBS project/account to charge for the run"
register_common_var "WALLTIME" "required" "" "" "PBS walltime"
register_common_var "QUEUE" "required" "" "preemptable debug debug-scaling prod capacity" "PBS queue name"
