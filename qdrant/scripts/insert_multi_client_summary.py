...
for i in range(clients):
    ...
    prep, pArr = summarize_npy(f"batch_construction_times_rank_{i}.npy",i, "prep",batch_size)
    upload, uArr = summarize_npy(f"upload_times_rank_{i}.npy",i, "upload",batch_size)
    op, opArr = summarize_npy(f"op_times_rank_{i}.npy",i, "op",batch_size)
