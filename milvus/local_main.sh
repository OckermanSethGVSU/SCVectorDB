...
run_mixed() {
    ...
    export MIXED_RESULT_PATH INSERT_CLIENTS QUERY_CLIENTS COLLECTION_NAME VECTOR_FIELD ID_FIELD TOP_K QUERY_EF_SEARCH EFSearch SEARCH_CONSISTENCY RPC_TIMEOUT
